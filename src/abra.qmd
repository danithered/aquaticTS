...
execute: 
  echo: false
params:
  dir: "/home/danielred/data/programs/aquaticTS/OUT/test_9"
editor_options: 
...
last_types <- cbind(
  last_types, 
  do.call(rbind, lapply(last_types$type, function(x) types[types$type == x, c("Trange", "Tmin", "Topt")]) )
  )
  ...
  birth <- birth +
    geom_function(fun = only_rep, 
                  args=list(R=res, 
                            ...
                            b=as.numeric(par$`Eppley-shape`), A=as.numeric(par$`Eppley-scale`), 
