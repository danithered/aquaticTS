...
execute: 
  echo: false
params:
  dir: "/home/danielred/data/programs/aquaticTS/OUT/test_20"
editor_options: 
...
net_rep_range <- function(Ts, R, Tmin, Trange, b, flatness, baseline, pow, A, attack, handling, constdeath=F){
  ...
  for(T in Ts){
    ...
    compensation = (2+b+(b-2)*exp(b))*Trange^3/b^3/A/feeding
    birth <- b6mod(T, Tmin, Tmax, Trange, b, compensation)
    de <- d9_12(T, Tmin, Trange, flatness=flatness, baseline=baseline, pow=pow, at=Topt, constdeath = constdeath)
